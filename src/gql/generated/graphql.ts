...
export type GalleryFragmentFragment = { __typename?: 'Gallery', id: string, name: string, description: string, releaseDay: any, isViewable: boolean, isCommentable: boolean } & { ' $fragmentName'?: 'GalleryFragmentFragment' };
...
export type GetGalleryGroupQuery = { __typename?: 'Query', galleryGroup?: { __typename?: 'GalleryGroup', id: string, name: string, slug: string, isAvailable: boolean, galleries: (
      { __typename?: 'GalleryConnection' }
